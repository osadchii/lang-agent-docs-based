...
- Ученику становятся доступны темы для изучения, предоставленные учителем
- Ученику становятся доступны колоды с карточками, предоставленные учителем

**Ограничения:**

- Ученик не может редактировать групповые материалы
- Доступны только для изучения и практики

**Синхронизация:**

- При обновлении материалов учителем изменения автоматически отражаются у учеников
...
- Учитель имеет все права ученика
- Дополнительно может создавать и управлять группами
...
1. Учитель отправляет команду с идентификатором пользователя
...
5. Учитель получает уведомление о решении пользователя 

### UC-10: Создание и распространение материалов для учеников

**Создание материалов:**

- Учитель может создавать темы для упражнений
- Учитель может создавать колоды карточек
...
- При предоставлении доступа ученики получают уведомление

**Синхронизация изменений:**

- При изменении учителем материалов (тем или колод)
- Изменения автоматически отражаются у всех учеников, имеющих доступ 
